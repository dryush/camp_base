...
class CampsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create camp" do
    assert_difference('Camp.count') do
      post camps_url, params: { camp: { city_id: @camp.city_id, description: @camp.description, name: @camp.name } }
    end
  ...
  test "should update camp" do
    patch camp_url(@camp), params: { camp: { city_id: @camp.city_id, description: @camp.description, name: @camp.name } }
